...
export const testimonials: TestimonialEntry[] = [
  ...
  },
  {
    ...
    industry: "Technology",
    text: {
      de: "Die digitale Transformation unseres Traditionsunternehmens war ein Mammutprojekt mit enormem Widerstand. Anatoly begleitete uns durch den gesamten Change-Prozess. Seine Fähigkeit, Klarheit in chaotische Situationen zu bringen, war entscheidend. Er half mir, Resilienz aufzubauen und mein Team durch Unsicherheit zu führen. Nach 18 Monaten ist die Transformation abgeschlossen und die Ergebnisse übertreffen unsere Erwartungen. Die Teamfluktuation sank um 25 Prozent, weil die Menschen wieder Sinn und Richtung in ihrer Rolle sehen. Anatoly ist kein Coach, der nur redet — er liefert.",
  ...
  // ─── Education (3) ─────────────────────────────────────────────────
  {
    ...
    industry: "Education",
    text: {
      de: "Die Leitung einer Hochschule bedeutet, viele Stakeholder mit unterschiedlichsten Interessen zusammenzubringen. Ich suchte nach einem Weg, meine Führungsrolle bewusster zu gestalten. Anatoly Mooks Seminar zur bewussten Führung eröffnete mir völlig neue Perspektiven. Ich lernte, Konflikte nicht zu vermeiden, sondern als Chance für Klarheit zu nutzen. Die Zusammenwirkung im Rektorat verbesserte sich fundamental. Unsere strategische Planung wurde fokussierter, und die Zufriedenheit der Fakultäten stieg messbar. Anatoly versteht die besonderen Herausforderungen im Bildungsbereich und liefert maßgeschneiderte Lösungen statt Standardrezepte.",
  ...
  },
  {
    ...
    industry: "Education",
    text: {
      de: "Die akademische Welt ist geprägt von Ego und Konkurrenz. Als Dekan der Wirtschaftsfakultät wollte ich eine Kultur des gemeinsamen Wirkens etablieren, stieß aber auf enormen Widerstand. Anatoly Mooks Transformationsprogramm half mir, zunächst meine eigene Haltung zu klären und dann schrittweise das Kollegium mitzunehmen. Sein Ansatz ist weder konfrontativ noch weich — er ist klar. Diese Klarheit war ansteckend. Heute kooperieren unsere Lehrstühle enger als je zuvor, und wir haben drei interdisziplinäre Forschungsprojekte gestartet. Die Potenzialentfaltung, die Anatoly ermöglicht, geht weit über individuelle Entwicklung hinaus.",
  ...
  },
  {
    ...
    industry: "Consulting",
    text: {
      de: "Als Principal mit Teams in fünf Ländern war die Herausforderung, über Distanz und Kulturen hinweg klar zu führen. Anatoly Mooks Seminare zur Entscheidungsstärke gaben mir Werkzeuge, die kulturübergreifend funktionieren. Ich lernte, dass Klarheit eine universelle Sprache ist. Meine internationalen Teams wirken heute kohärenter zusammen, und die Projektqualität verbesserte sich in allen Regionen. Besonders wertvoll war die Erkenntnis, dass bewusste Führung nicht mehr Zeit kostet, sondern Zeit spart. Die Effizienz meiner Teams stieg um 22 Prozent. Anatoly ist der seltene Mentor, der Theorie und Praxis nahtlos verbindet.",
  ...
  // ─── Retail (2) ────────────────────────────────────────────────────
  {
    ...
    industry: "Retail",
    text: {
      de: "Als Geschäftsführerin in dritter Generation stand ich vor der Aufgabe, ein traditionsreiches Handelsunternehmen in die digitale Zukunft zu führen. Die Last der Familienerwartungen und der Widerstand langjähriger Teammitgliederr machten mir zu schaffen. Anatoly Mook half mir, Klarheit über meine eigene Vision zu gewinnen und diese mit Überzeugung zu vertreten. Sein Transformationsprogramm begleitete den gesamten Wandel. Heute betreiben wir erfolgreich 35 Filialen und einen florierenden Online-Shop. Der Umsatz stieg um 40 Prozent. Aber wichtiger: Die Familie und das Team stehen hinter der neuen Richtung. Anatoly hat nicht nur mein Unternehmen, sondern mein Selbstverständnis als Führungskraft transformiert.",
