...
const mainRoutesDe: Array<{ path: string; section: string; titleDe: string; titleEn: string; titleRu: string; descDe: string; descEn: string; descRu: string; priority: number }> = [
  ...
  { path: '/transformation', section: 'transformation', titleDe: 'Transformation – Bewusstsein vertiefen', titleEn: 'Transformation – Deepen Consciousness', titleRu: 'Трансформация – углубление осознанности', descDe: 'Unbewusst vs. bewusst, Transformations-Karten und vertiefende Inhalte.', descEn: 'Unconscious vs conscious living, transformation cards and deeper content.', descRu: 'Неосознанное и осознанное существование, карты трансформации и углублённый контент.', priority: 0.8 },
  { path: '/bewusstsein', section: 'bewusstsein', titleDe: 'Neues Bewusstsein – Klarheit & Paradigmen', titleEn: 'New Consciousness – Clarity & Paradigms', titleRu: 'Новое сознание – ясность и парадигмы', descDe: 'Lebensbereiche, Meisterschaft und Paradigmen wie Angsttransparenz — Bewusstsein als gelebte Haltung.', descEn: 'Life areas, mastery and paradigms such as fear transparency — consciousness as lived stance.', descRu: 'Сферы жизни, мастерство и парадигмы — сознание как живая позиция.', priority: 0.85 },
  { path: '/methodik', section: 'methodik', titleDe: 'Methodik – Drei Ebenen & Prozess', titleEn: 'Methodology – Three Levels & Process', titleRu: 'Методика – три уровня и процесс', descDe: 'Achtsamkeitslehre, Bewusstseinstraining, Transformation — Journey, Dimensionen und konkreter Prozess.', descEn: 'Mindfulness teaching, consciousness training, transformation — journey and dimensions.', descRu: 'Обучение осознанности, тренировка сознания, трансформация — путь и измерения.', priority: 0.85 },
