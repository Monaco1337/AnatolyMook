...
const mainRoutes = [
  ...
  { path: '/transformation', title: 'Transformation – Bewusstsein im Alltag vertiefen', description: 'Unbewusst vs. bewusst leben plus Transformations-Karten und Slider-Inhalte von Anatoly Mook.' },
  { path: '/bewusstsein', title: 'Neues Bewusstsein – Klarheit, Selbstführung & Paradigmen', description: 'Lebensbereiche, Meisterschaft, Paradigmen (Angsttransparenz u.a.) und was Bewusstsein jenseits des Konzepts bedeutet.' },
  { path: '/methodik', title: 'Methodik – Drei Ebenen, Achtsamkeit & Bewusstseinstraining', description: 'Drei Dimensionen der Arbeit: Achtsamkeitslehre, Bewusstseinstraining, Transformation – Journey und konkrete Ebenen.' },
