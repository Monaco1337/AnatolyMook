...
export default function TransformationCanvas() {
  ...
  useEffect(() => {
    ...
    const colors = ['#B9823F', '#8A5528', '#7A4A24', '#ea580c', '#dc2626'];
    ...
    const animate = () => {
      ...
      particles.forEach((particle, i) => {
        ...
        particles.forEach((otherParticle, j) => {
          ...
          if (distance < 120) {
            ctx.beginPath();
            ctx.strokeStyle = `rgba(185, 130, 63, ${0.15 * (1 - distance / 120)})`;
            ctx.lineWidth = 0.5;
    ...
    <div ref={sectionRef} className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative max-w-[1600px] mx-auto px-8 py-40">
                ...
                >
                  <div
                    className={`
                      ...
                      ${level.borderColor}
                      ${isActive ? `${level.glowColor} shadow-[0_0_80px_rgba(185, 130, 63, 0.4)] scale-105 -translate-y-4` : 'shadow-2xl shadow-black/50'}
                    `}
                    style={{
        ...
        >
          ...
          <div className="relative p-16 rounded-[2rem] border border-amber-500/30 backdrop-blur-2xl overflow-hidden group-hover:border-amber-500/60 transition-all duration-1000 group-hover:shadow-[0_0_60px_rgba(185, 130, 63, 0.3)]">
            ...
            {qualities.map((quality, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative p-10 rounded-3xl border border-zinc-800/50 backdrop-blur-xl group-hover:border-amber-500/40 transition-all duration-1000 overflow-hidden group-hover:shadow-[0_0_40px_rgba(185, 130, 63, 0.2)] group-hover:-translate-y-2">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="pt-20 border-t border-zinc-800/50">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <button className="group relative px-10 py-5 border border-zinc-700 hover:border-amber-500/60 rounded-2xl text-zinc-300 hover:text-white transition-all duration-700 hover:shadow-[0_0_40px_rgba(185, 130, 63, 0.2)] hover:scale-105 backdrop-blur-xl overflow-hidden">
