...
export const topicClusters: TopicCluster[] = [
...

  {
    ...
    description: {
      de: 'Bewusstseinsentwicklung ist der Schlüssel zu einem erfüllten Leben und bewusster Führung. Anatoly Mook begleitet Sie auf dem Weg zu tieferem Selbstverständnis und erweitertem Bewusstsein – durch erprobte Methoden aus Coaching, Mentoring und Bewusstseinsführung.',
...

  {
    ...
    description: {
      de: 'Executive Coaching auf höchstem Niveau: Anatoly Mook begleitet vertraulich Führungskräfte und Entscheider, um blinde Flecken aufzudecken, Klarheit zu gewinnen und die eigene Führungswirkung nachhaltig zu stärken.',
      en: 'Executive coaching at the highest level: Anatoly Mook accompanies leaders and decision-makers in confidence to uncover blind spots, gain clarity, and sustainably strengthen their leadership impact.',
      ru: 'Экзекутивный коучинг на высшем уровне: Анатолий Мук конфиденциально сопровождает руководителей и лиц, принимающих решения, чтобы выявить слепые зоны, обрести ясность и устойчиво усилить лидерское влияние.',
    },
    metaTitle: {
...

  {
    ...
    description: {
      de: 'Das richtige Mindset ist die Grundlage großer Führung. Anatoly Mook vertieft mit Ihnen die innere Haltung, die Sie brauchen, um mit Klarheit, Resilienz und Weitsicht zu führen.',
      en: 'The right mindset is the foundation of great leadership. Anatoly Mook deepens with you the inner posture you need to lead with clarity, resilience, and foresight.',
      ru: 'Правильный майндсет — основа великого лидерства. Анатолий Мук углубляет вместе с вами внутреннюю позицию, необходимую для руководства с ясностью, стойкостью и дальновидностью.',
    },
    metaTitle: {
...

  {
    ...
    description: {
      de: 'Die Unternehmenskultur bestimmt, wie Menschen sich abstimmen und Entscheidungen treffen. Anatoly Mook begleitet Organisationen dabei, eine Kultur zu schaffen, die Sinn stiftet, Vertrauen fördert und Exzellenz ermöglicht.',
      en: 'Corporate culture determines how people align and make decisions. Anatoly Mook accompanies organizations in creating a culture that provides meaning, fosters trust, and enables excellence.',
      ru: 'Корпоративная культура определяет, как люди согласуют действия и принимают решения. Анатолий Мук помогает организациям создать культуру, которая придаёт смысл, укрепляет доверие и открывает путь к совершенству.',
    },
    metaTitle: {
...

  {
    ...
    title: {
      de: 'New Work',
      en: 'New Work',
      ru: 'Новые формы смыслового участия',
    },
    description: {
      de: 'New Work ist mehr als ein Trend – es ist ein Bewusstseinswandel in der Art, wie Organisationen wirken und Menschen sich begegnen. Anatoly Mook begleitet Organisationen und Führungskräfte dabei, Rollen und Formate neu zu ordnen: sinnstiftend, menschlich und zukunftsfähig.',
      en: 'New Work is more than a trend – it is a shift in how organizations take effect and how people meet each other. Anatoly Mook accompanies organizations and leaders in rethinking roles and formats: meaningful, human, and future-ready.',
      ru: 'New Work — больше, чем тренд: это сдвиг в том, как организации создают эффект и как люди встречаются. Анатолий Мук сопровождает компании и руководителей в переосмыслении ролей и форматов — осмысленно, по-человечески и устойчиво.',
    },
    metaTitle: {
      de: 'New Work – Anatoly Mook',
      en: 'New Work – Anatoly Mook',
      ru: 'New Work – Анатолий Мук',
    },
    metaDescription: {
      de: 'New Work mit Anatoly Mook. Formate und Rollen neu ordnen – sinnstiftend, menschlich und zukunftsfähig für Organisationen und Führungskräfte.',
      en: 'New Work with Anatoly Mook. Rethink roles and formats – meaningful, human, and future-ready for organizations and leaders.',
      ru: 'New Work с Анатолием Муком. Пересоберите роли и форматы — осмысленно, по-человечески и с прицелом в будущее.',
    },
    keywords: {
      de: ['New Work', 'neue Organisationsformate', 'Sinn-orientierte Führung', 'Zukunft der Zusammenwirkung', 'sinnhafte Ausrichtung'],
      en: ['new work', 'future of organizations', 'meaningful collaboration', 'conscious organizations', 'new formats of impact'],
      ru: ['New Work', 'новые форматы организации', 'смысловое участие', 'осознанные организации', 'новые формы воздействия'],
    },
...

  {
    ...
    title: {
      de: 'Motivation im Team',
      en: 'Employee Motivation',
      ru: 'Мотивация сотрудников',
    },
    description: {
      de: 'Echte Motivation im Team entsteht nicht durch Anreize, sondern durch Sinn und Verbindung. Anatoly Mook zeigt Führungskräften, wie sie intrinsische Motivation wecken und ein Umfeld schaffen, in dem Menschen aufblühen.',
    ...
    metaTitle: {
      de: 'Motivation im Team – Anatoly Mook',
      en: 'Employee Motivation – Anatoly Mook',
      ru: 'Мотивация сотрудников – Анатолий Мук',
    },
    metaDescription: {
      de: 'Steigern Sie die Motivation im Team mit Anatoly Mook. Intrinsische Motivation wecken durch Sinn, Verbindung und bewusste Führung.',
    ...
    keywords: {
      de: ['Team-Motivation', 'Motivation steigern', 'intrinsische Motivation', 'Team-Engagement', 'Motivation im Organisationsalltag'],
...

  {
    ...
    description: {
      de: 'Anatoly Mook setzt vielfältige Coaching-Methoden ein, die tiefgreifende Veränderung ermöglichen. Von systemischem Coaching über Bewusstseinsführung bis hin zu körperorientierten Ansätzen – stets individuell abgestimmt auf Ihre Bedürfnisse.',
    ...
    metaDescription: {
      de: 'Vielfältige Coaching-Methoden von Anatoly Mook. Systemisches Coaching, Bewusstseinsführung und mehr – individuell auf Sie abgestimmt.',
...

  {
    ...
    description: {
      de: 'Einzelcoaching mit Anatoly Mook bietet Ihnen einen geschützten Raum für tiefe persönliche Vertiefung. In vertraulichen Sitzungen klären und vertiefen Sie Ihre individuellen Herausforderungen und Ziele – mit voller Aufmerksamkeit und maßgeschneiderter Begleitung.',
      en: 'Individual coaching with Anatoly Mook offers you a protected space for deep personal deepening. In confidential sessions, you clarify and deepen your individual challenges and goals – with full attention and tailored guidance.',
      ru: 'Индивидуальный коучинг с Анатолием Муком предлагает защищённое пространство для глубокой личной углублённой практики. В конфиденциальных сессиях вы проясняете и углубляете свои вызовы и цели — с полным вниманием и индивидуальным сопровождением.',
    },
    metaTitle: {
    ...
    metaDescription: {
      de: 'Einzelcoaching mit Anatoly Mook. Vertrauliche Sitzungen für tiefe persönliche Vertiefung bei Ihren Herausforderungen und Zielen.',
      en: 'Individual coaching with Anatoly Mook. Confidential sessions for deep personal deepening on your challenges and goals.',
      ru: 'Индивидуальный коучинг с Анатолием Муком. Конфиденциальные сессии для глубокой практики в отношении ваших вызовов и целей.',
    },
    keywords: {
...

  {
    ...
    keywords: {
      de: ['Gruppencoaching', 'Gruppen-Coaching', 'Gruppenformat', 'kollektives Coaching', 'Gruppenprozess'],
...

  {
    ...
    metaDescription: {
      de: 'Transformative Retreats mit Anatoly Mook. Ein Raum außerhalb des Alltags für tiefe innere Vertiefung und neue Kraft.',
      en: 'Transformative retreats with Anatoly Mook. A space outside daily life for deep inner deepening and renewed strength.',
      ru: 'Трансформативные ретриты с Анатолием Муком. Пространство вне повседневности для глубокой внутренней практики и новой силы.',
    },
    keywords: {
...

  {
    ...
    title: {
      de: 'Bewusstseinsführung',
      en: 'Consciousness Practice',
      ru: 'Практика сознания',
    },
    description: {
      de: 'Bewusstseinsführung ist das Herzstück von Anatoly Mooks Methodik. Durch gezielte Praktiken und Prozesse erweitern Sie Ihr Bewusstsein, erkennen verborgene Muster und erschließen neue Möglichkeitsräume.',
      en: 'Consciousness practice is the heart of Anatoly Mook\'s methodology. Through targeted practices and processes, you expand your awareness, recognize hidden patterns, and open new possibility spaces.',
      ru: 'Практика сознания — сердце методологии Анатолия Мука. Через целенаправленные практики и процессы вы расширяете осознанность, распознаёте скрытые паттерны и открываете новые пространства возможностей.',
    },
    metaTitle: {
      de: 'Bewusstseinsführung – Anatoly Mook',
      en: 'Consciousness Practice – Anatoly Mook',
      ru: 'Практика сознания – Анатолий Мук',
    },
    metaDescription: {
      de: 'Bewusstseinsführung mit Anatoly Mook. Gezielte Praktiken zur Erweiterung Ihres Bewusstseins und Entdeckung neuer Möglichkeiten.',
      en: 'Consciousness practice with Anatoly Mook. Targeted practices to expand your awareness and discover new possibilities.',
      ru: 'Практика сознания с Анатолием Муком. Целенаправленные практики для расширения осознанности и открытия новых возможностей.',
    },
    keywords: {
      de: ['Bewusstseinsführung', 'Bewusstseinspraxis', 'Bewusstseinsvertiefung', 'innere Klärung', 'Bewusstseinscoaching'],
      en: ['consciousness practice', 'awareness practice', 'consciousness exploration', 'inner deepening', 'consciousness coaching'],
      ru: ['практика сознания', 'осознанность', 'исследование сознания', 'внутренняя углублённость', 'коучинг сознания'],
    },
    relatedServices: ['coaching', 'retreat', 'seminare'],
...

  {
    ...
    title: {
      de: 'Körperpraxis und Bewusstsein',
      en: 'Body Practice and Consciousness',
      ru: 'Телесная практика и сознание',
    },
    description: {
      de: 'Der Körper speichert Erfahrungen und Weisheit. Anatoly Mook integriert Körperpraxis in seine Begleitung, um über den Körper Zugang zu tieferen Bewusstseinsebenen zu schaffen und ganzheitliche Transformation zu ermöglichen.',
      en: 'The body stores experiences and wisdom. Anatoly Mook integrates body-centered practice into his guidance to create access to deeper levels of consciousness through the body and enable holistic transformation.',
      ru: 'Тело хранит опыт и мудрость. Анатолий Мук интегрирует телесную практику в сопровождение, чтобы через тело открыть доступ к глубоким уровням сознания и обеспечить целостную трансформацию.',
    },
    metaTitle: {
      de: 'Körperpraxis & Bewusstsein – Anatoly Mook',
      en: 'Body Practice & Consciousness – Anatoly Mook',
      ru: 'Телесная практика и сознание – Анатолий Мук',
    },
    metaDescription: {
      de: 'Körperpraxis und Bewusstsein mit Anatoly Mook. Ganzheitliche Transformation durch die Verbindung von Körper und Geist.',
      en: 'Body practice and consciousness with Anatoly Mook. Holistic transformation through the connection of body and mind.',
      ru: 'Телесная практика и сознание с Анатолием Муком. Целостная трансформация через связь тела и ума.',
    },
    keywords: {
      de: ['Körperpraxis', 'Körperbewusstsein', 'Soma', 'Embodiment', 'ganzheitliche Vertiefung'],
      en: ['body practice', 'body awareness', 'soma', 'embodiment', 'holistic deepening'],
      ru: ['телесная практика', 'телесное осознание', 'сома', 'воплощение', 'целостное углубление'],
    },
    relatedServices: ['coaching', 'retreat', 'seminare'],
